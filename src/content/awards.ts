export const awards = [
  {
    ...
    locales: {
      ko: {
        ...
        summary: "파킨슨병(PD) 및 알츠하이머(AD) 조기 진단을 위한 AI 모델 및 데이터 수집",
        project: "PAD-AI"
      },
      en: {
        title: "2023 KU SW Contest, Excellence Award",
        summary:
          "AI model and data collection project for early diagnosis of Parkinson’s disease and Alzheimer’s disease",
        project: "PAD-AI"
      }
    }
  },
  ...
  },
  {
    ...
    locales: {
      ...
      en: {
        ...
        summary: "Map-based social networking app using the Naver Zepeto API",
        project: "Zepetalk"
      }
    }
  }
